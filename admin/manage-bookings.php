...
<head>
	...
	<title>SPDS |Admin Manage testimonials   </title>
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									?>	
										...
										?>
											<td>
												<a href="manage-bookings.php?rid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Confirming the vehicle was paid')"> paid</a>
											</td>
										<?php
											}else if($result->Status == 2){
										?>
										...
										?>
											<td>
												<a href="manage-bookings.php?rid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Confirming payment')"> paid</a>/
												<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Cancel this Booking')"> Cancel</a>
											</td>
										<?php
											}
