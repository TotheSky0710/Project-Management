...
<head>
	...
	<title>SPDS | Manage Vehicles   </title>
...
<?php $sql = "SELECT tblvehicles.VehiclesTitle,tblbrands.BrandName,tblvehicles.id from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where user_id = :uid";
$query = $dbh -> prepare($sql);
