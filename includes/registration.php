...
if(isset($_POST['signup'])){
  ...
  $sql="INSERT INTO  tblusers(UserType,FullName,EmailId,contactno,Password,LenderLat,LenderLng) VALUES(:type,:fname,:email,:mobileno,:password, :lat, :lng)";
            ...
            <div class="col-md-12 col-sm-6">
              <form  method="post" name="signup" action="#" onSubmit="return valid();" enctype="multipart/form-data">
                ...
                <div class="form-group text-center my-3">
                 <i class="fa fa-car"></i>&nbsp;Driver &nbsp;<input class="usertype-button" id="lender" value="0" type="radio" name="usertype"  required="required">
                 <span class="m-auto" style="margin-left:20px; margin-right:20px;">OR</span>
                 
                 <i class="fa fa-key"></i>&nbsp;student &nbsp; <input class="usertype-button" id="renter" value="1" type="radio" name="usertype"  required="required">
                </div>
         ...
         <hr style="width:50%;">
                <div class="form-group">
                  ...
                  <span id="lender-availability-status" style="font-size:12px;"></span> 
                      ...
                      <div class="form-group">
                  <input type="text" class="form-control" name="mobileno" placeholder="Mobile Number include +254" maxlength="15" required="required">
                </div>
                <div class="form-group">
