...
$query->bindParam(':uid',$_SESSION['uid'],PDO::PARAM_INT);
									...
									?>	
										...
										?>
											<td>
												<a href="manage-bookings.php?rid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Confirming the payment was done')"> paid</a>
											</td>
										<?php
											}else if($result->Status == 2){
										?>
										...
										?>
													<td>
														<p class="text-center">Waiting for user's confirmation.</p>
													</td>
										<?php
													}else{
										?>
													...
													<td>
														<a href="manage-bookings.php?rid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Confirming the payment was done ')"> payment</a>
														<!-- <a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Cancel this Booking')"> Cancel</a> -->
													</td>
										<?php
													}
